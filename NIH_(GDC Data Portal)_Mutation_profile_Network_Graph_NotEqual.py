...
#This module buildes the network graph by connecting cases with similiar mutations profiles, except ones that have the same number of mutations.
...
name_files()
health_cell()
#dir_list = ['test_folder', 'Analyzed_Data', 'Raw_Data']
match_maker()
